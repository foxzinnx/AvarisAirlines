                ...
                <div className="flex flex-col justify-center p-11 items-center">
                    <div className="flex flex-col items-center">
                        <Image
                            ...
                            width={70}
                        />
                        <p className="font-bold text-[1.6rem] pt-4">Cadastre-se</p>
                        <p className="text-[#333333] text-[15px] font-medium">Crie sua conta para continuar</p>
                    </div>

                    <div className="mt-6 flex flex-col gap-2">
                        <h1 className="text-[14.5px] font-medium">Nome</h1>
                        <div className={`border-2 ${nomeTouched && !nome ? 'border-red-500' : 'border-neutral-300'} rounded-md h-12 flex items-center w-[330px]`}>
                            <input 
                                type="text" 
                                placeholder="Insira seu nome completo" 
                                className={`w-full h-full px-2 rounded-md ${nomeTouched && !nome ? 'outline-red-500' : 'outline-neutral-400 focus:outline-2'} placeholder:text-[#808080] text-[15px] placeholder:text-[14px]`}
                                value={nome}
                        ...
                        {nomeTouched && !nome && (
                            <p className="text-red-500 text-[13px]">Insira seu nome completo</p>
                        )}
                    </div>
                    ...
                    <Link href={"/pt"}>
                        <div className="mt-6 flex flex-col gap-2">
                            <div className="bg-red-500 cursor-pointer hover:bg-[#fc4242] transition-colors duration-300 rounded-md h-12 flex justify-center items-center w-[330px]">
                                <button className="text-white font-bold cursor-pointer text-[15.5px]">Criar conta</button>
                            </div>
                        </div>
                    </Link>
                    ...
                    <div className="mt-4 flex items-center justify-center gap-2">
                        <div className="border border-neutral-300 hover:bg-neutral-100 cursor-pointer transition-colors duration-300 rounded-md h-12 flex gap-2 justify-center items-center w-[330px]">
                            ...
                            <p id="google">Inscrever-se com Google</p>
                        </div>
                    </div>

                    <div className="mt-6 flex justify-center items-center">
                        <p id="entrar" className="text-[14px]">Já tem uma conta? <Link href={"/pt/signin"} className="text-red-500 font-bold text-[13.4px]" id="enter">Entrar</Link></p>
                    </div>
                </div>
            </div>
        </div>
