                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex flex-col gap-7">
                            ...
                            <div className="flex flex-col gap-3 justify-start items-start font-light text-[14.5px]">
                                ...
                                <p className="hover:scale-105 hover:text-red-500 hover:font-medium  transition-transform duration-300 cursor-pointer hover:drop-shadow-md">Informação legao</p>
