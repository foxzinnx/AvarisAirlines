                ...
                <div className="flex flex-col justify-center p-11 items-center">
                    <div className="flex flex-col items-center">
                        <Image
                            ...
                            width={70}
                        />
                        <p className="font-bold text-[1.5rem] pt-4">Create your account</p>
                        <p className="text-[#333333] text-[14px] font-medium">Create your account to continue</p>
                    </div>

                    <div className="mt-6 flex flex-col gap-2">
                        <h1 className="text-[14.5px] font-medium">Name</h1>
                        ...
                        {nomeTouched && !nome && (
                            <p className="text-red-500 text-[13px]">Enter your full name</p>
                        )}
                    </div>
                    ...
                    <Link href={"/en"}>
                        <div className="mt-6 flex flex-col gap-2">
                            <div className="bg-red-500 cursor-pointer hover:bg-[#fc4242] transition-colors duration-300 rounded-md h-12 flex justify-center items-center w-[330px]">
                                <button className="text-white font-bold cursor-pointer text-[15.5px]">Sign Up</button>
                            </div>
                        </div>
                    </Link>
                    ...
                    <div className="mt-6 flex justify-center items-center">
                        <p id="entrar" className="text-[14px]">Already have an account? <Link href={"/en/signin"} className="text-red-500 font-bold text-[13.4px]" id="enter">Log In</Link></p>
                    </div>
                </div>
            </div>
        </div>
